...
const Cart = () => {
  ...
  useEffect(() => {
    const fetchCartData = async () => {
      try {
        const cartResponse = await axios.get(`${backendGlobalRoute}/api/get-cart-items`);
        setCartItems(cartResponse.data.cartItems || {});
        const foodResponse = await axios.get(`${backendGlobalRoute}/api/all-foods`);
  ...
  const removeFromCart = async (id) => {
    try {
      await axios.post(`${backendGlobalRoute}/api/remove-cart-item`, { id });
      setCartItems((prev) => {
